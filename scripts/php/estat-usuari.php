...
if (!empty($_SESSION['id_user'])) {
    ...
    // Recuperem codi postal, radi i data de naixement de la taula 'users'
    $stmt = $conn->prepare("SELECT codi_postal, radi_localitzacio, data_naixement FROM users WHERE id_user = ?");
    ...
    echo json_encode([
        ...
        'data_naixement' => $fila['data_naixement'] ?? null,
